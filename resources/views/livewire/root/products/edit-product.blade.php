    ...
    <form wire:submit="save" class="card space-y-6">
        ...
        <div>
            ...
            <textarea wire:model="description" id="description" rows="3"
                      class="input-dark mt-1.5 @error('description') input-dark-error @enderror"></textarea>
        ...
        <div>
            <div class="flex items-center justify-between gap-4">
                <div>
                    ...
                    <p class="help-text">Produtos arquivados não aparecem para os tenants.</p>
                </div>
        ...
        <div class="flex items-center justify-end gap-3 border-t border-white/10 pt-6">
            ...
            <a href="{{ route('root.products.integrations', $product) }}" class="btn-secondary">Gerenciar integrações</a>
