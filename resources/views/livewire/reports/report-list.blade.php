<div>
    ...
    <div class="mb-6 flex items-center justify-between">
        <div>
            <h1 class="text-2xl font-bold text-gray-900">Meus Relatórios</h1>
            <p class="mt-1 text-sm text-gray-500">Acompanhe o status dos seus relatórios enviados.</p>
        </div>
        <a
        ...
        <table class="min-w-full divide-y divide-gray-200 text-sm">
            <thead class="bg-gray-50">
                <tr>
                    ...
                    <th class="px-6 py-3 text-left text-xs font-semibold uppercase tracking-wider text-gray-600">Votos</th>
                    ...
                    <tr class="hover:bg-gray-50 transition-colors">
                        ...
                        <td class="px-6 py-4 text-gray-700">
                            @if($report->status->canReceiveVotes())
                                <span class="font-semibold">{{ $report->vote_count }}</span>
                            @else
                        ...
                        <td class="px-6 py-4 text-right">
                            <div class="flex items-center justify-end gap-3">
                                <a
                                    href="{{ route('app.reports.show', $report) }}"
                                    wire:navigate
                                ...
                                @if($report->status->value === 'pending_review')
                                    <a
                                        ...
                                        wire:navigate
                                        class="text-gray-500 hover:text-gray-800 font-medium transition-colors"
                                    >
                                        Editar
                                    </a>
                                @endif
                ...
                @empty
                    <tr>
                        <td colspan="6" class="px-6 py-16 text-center text-gray-400">
                            ...
                            <p class="mt-1 text-sm">Tente ajustar os filtros ou envie um novo relatório.</p>
                        </td>
                    </tr>
                @endforelse
            </tbody>
