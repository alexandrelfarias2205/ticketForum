<div class="max-w-3xl mx-auto space-y-8">
    ...
    {{-- Cabeçalho --}}
    <div>
        <h1 class="text-2xl font-bold text-gray-900">Editar Relatório</h1>
        <p class="mt-1 text-sm text-gray-500">Você pode editar este relatório enquanto ele ainda aguarda revisão.</p>
    </div>
