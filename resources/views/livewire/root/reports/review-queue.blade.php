                ...
                <tbody>
                    @forelse($this->reports as $report)
                        <tr>
                            ...
                            <td class="text-right">
                                <a href="{{ route('root.reports.show', $report) }}" wire:navigate
                                   class="inline-flex items-center gap-1 text-sm font-medium text-brand-300 transition hover:text-brand-200">
                                    Revisar
